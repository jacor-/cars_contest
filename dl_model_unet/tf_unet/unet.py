...
from dl_model_unet.tf_unet import util
from dl_model_unet.tf_unet.layers import (weight_variable, weight_variable_devonc, bias_variable, 
...
class Trainer(object):
    ...
    def train(self, data_provider, output_path, training_iters=10, epochs=100, dropout=0.75, display_step=1, restore=False):
        ...
        with tf.Session() as sess:
            ...
            test_x, test_y = data_provider.__next__()#(self.verification_batch_size)
            ...
            for epoch in range(epochs):
                ...
                for step in range((epoch*training_iters), ((epoch+1)*training_iters)):
                    batch_x, batch_y = data_provider.__next__()#(self.batch_size)
